...
export function Header({ activeTab, supabase }: HeaderProps) {
    return (
            ...
            <header className="bg-white shadow-sm border-b border-gray-200 p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Badge className={`${supabase ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>{supabase ? 'Baza danych połączona' : 'Tryb demo'}</Badge>
