...
export function HomePageSettings({
  currentHeroImage = '/images/baner.webp',
  onSave,
  currentUser,
  ...
  return (
    <Card className="border-0 shadow-lg">
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          <Label className="text-sm font-medium text-gray-700 mb-2 block">
            Aktualne zdjęcie w sekcji głównej
          </Label>
          <div className="relative w-full h-48 bg-gray-100 rounded-lg overflow-hidden">
            <Image
              src={currentImage}
              alt="Aktualne zdjęcie strony głównej"
              fill
              className="object-cover"
              onError={() => setCurrentImage('/images/placeholder.svg')}
            />
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-1">
                Obsługiwane formaty: JPEG, PNG, WebP (maks. 5MB)
              </p>
            </div>
        ...
        <div className="border-t pt-4">
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              disabled={currentImage === '/images/baner.webp'}
            >
      ...
      <ConfirmDialog
        ...
        description="Czy na pewno chcesz przywrócić domyślne zdjęcie strony głównej? Bieżące zdjęcie nie zostanie usunięte."
