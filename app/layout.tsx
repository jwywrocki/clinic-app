...
export const metadata: Metadata = {
  ...
  keywords:
    'ośrodek zdrowia Łopuszno, lekarz rodzinny, pogotowie ratunkowe, SPZOZ, opieka medyczna, kardiolog, diabetolog, pediatra, Łopuszno zdrowie',
  authors: [{ name: 'SPZOZ Gminny Ośrodek Zdrowia w Łopusznie' }],
  robots: 'index, follow',
  openGraph: {
    title: 'SPZOZ Gminny Ośrodek Zdrowia w Łopusznie',
    description:
      'Profesjonalna opieka zdrowotna w sercu Łopuszna. Medycyna rodzinna, specjaliści, pogotowie 24/7.',
    type: 'website',
    locale: 'pl_PL',
