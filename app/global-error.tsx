                    ...
                    <div className="max-w-2xl mx-auto text-center">
                        <div className="mb-8">
                            <div className="w-24 h-24 mx-auto bg-red-100 rounded-full flex items-center justify-center mb-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-12 w-12 text-red-600" aria-hidden="true">
                                    <path
                                        strokeLinecap="round"
                            ...
                            <p className="text-lg text-gray-600 mb-6">Przepraszamy, ale wystąpił krytyczny błąd. Nasz zespół został powiadomiony i pracuje nad rozwiązaniem.</p>
                        </div>
