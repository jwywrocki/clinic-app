...
export function RichTextEditor({
  ...
  const insertImage = (url: string) => {
    if (!url) return;
    const styleAttr = (imageWidth || imageHeight) ? ` style="${imageWidth ? `width: ${imageWidth}px; ` : ''}${imageHeight ? `height: ${imageHeight}px; ` : 'height: auto;'}"` : '';
    const imageHtml = `<img src="${url}" alt="${imageAlt || ''}" class="editor-image"${styleAttr}>`;
          ...
          setTimeout(() => {
            ...
            if (columnsParent && columnsParent.classList.contains('editor-columns')) {
              ...
              columns.forEach(col => {
                if (
                  col !== columnNode &&
                  col.classList.contains('editor-column') &&
                  col.innerHTML.replace(/<br\s*\/?>(\s*)?/g, '').trim() === ''
                ) {
  ...
  return (
    <>
      ...
      <Card className={`w-full ${className}`}>
        <div
          role="toolbar"
          aria-label="Opcje formatowania"
          className="flex flex-wrap items-center gap-1 p-2 bg-gray-50 border-b rounded-t-lg"
        >
          ...
          <div className="flex items-center gap-1">
            <Button
              type="button"
              variant={formats.bulletList ? 'default' : 'outline'}
              size="sm"
            ...
            <Button
              type="button"
              variant={formats.numberedList ? 'default' : 'outline'}
              size="sm"
          ...
          <div className="flex items-center gap-1">
            <Button
              type="button"
              variant={formats.alignLeft ? 'default' : 'outline'}
              size="sm"
            ...
            <Button
              type="button"
              variant={formats.alignCenter ? 'default' : 'outline'}
              size="sm"
            ...
            <Button
              type="button"
              variant={formats.alignRight ? 'default' : 'outline'}
              size="sm"
            ...
            <Button
              type="button"
              variant={formats.alignJustify ? 'default' : 'outline'}
              size="sm"
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <span
                className="absolute bottom-1 right-1 block w-2 h-2 rounded-full border border-gray-400"
      ...
      >
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            ...
            {imageUploadError && (
              <div className="col-span-4 text-red-500 text-sm mb-2">{imageUploadError}</div>
            )}
            ...
            <div className="col-span-4 grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="image-width">Szerokość (px)</Label>
                <Input
                  id="image-width"
                  type="number"
                  value={imageWidth}
              ...
              <div>
                <Label htmlFor="image-height">Wysokość (px)</Label>
                <Input
                  id="image-height"
                  type="number"
                  value={imageHeight}
                  onChange={e => setImageHeight(e.target.value)}
                  placeholder="np. 200 (opcjonalnie)"
                  className="mt-1"
                />
              </div>
            </div>
                ...
                <img
                  ...
                  onError={e => {
                    ...
                    target.insertAdjacentHTML(
                      'afterend',
                      '<p class="text-red-500 text-center p-2">Nie można załadować obrazu</p>'
                    );
                  }}
                />
              </div>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                id="file-upload"
                type="file"
                onChange={e => setSelectedFile(e.target.files ? (e.target.files[0] ?? null) : null)}
                className="col-span-3"
              />
            </div>
            {selectedFile && (
